...
for index, round in enumerate(train_val_test_rounds):
    ...
    #load model
    model = torch.load("/home/bec32/project/ML_for_MJO/CNN/Ensemble_Results/Result_02/CNNMJO_Ben_MDL_leadTm"+str(leadTm)+"_ensm"+str(seed_num)+"_round"+str(index + 1)+'.pth', weights_only=False).to(device)
    model.eval()
    all_train_preds = []
    all_train_targets = []
    all_val_preds = []
    ...
    os.system("rm -rf " + dirSave + "CNNMJO_STRONG_CORR_Ben_OBS_leadTm"+str(leadTm)+"_ensm"+str(seed_num)+"_rund"+str(index+1)+"_Prdct_Train.nc")
    # wrt to netCDF
    os.system("rm -rf " + dirSave + "CNNMJO_STRONG_CORR_Ben_OBS_leadTm"+str(leadTm)+"_ensm"+str(seed_num)+"_rund"+str(index+1)+"_Prdct_Train.nc")
    create_NC = Dataset(dirSave+"CNNMJO_STRONG_CORR_Ben_OBS_leadTm"+str(leadTm)+"_ensm"+str(seed_num)+"_rund"+str(index+1)+"_Prdct_Train.nc", "w", format="NETCDF4")
    ...
    os.system("rm -rf " + dirSave + "CNNMJO_STRONG_CORR_Ben_OBS_leadTm"+str(leadTm)+"_ensm"+str(seed_num)+"_rund"+str(index+1)+"_Prdct_Val.nc")
    # wrt to netCDF
    os.system("rm -rf " + dirSave + "CNNMJO_STRONG_CORR_Ben_OBS_leadTm"+str(leadTm)+"_ensm"+str(seed_num)+"_rund"+str(index+1)+"_Prdct_Val.nc")
    create_NC = Dataset(dirSave+"CNNMJO_STRONG_CORR_Ben_OBS_leadTm"+str(leadTm)+"_ensm"+str(seed_num)+"_rund"+str(index+1)+"_Prdct_Val.nc", "w", format="NETCDF4")
    ...
    os.system("rm -rf " + dirSave + "CNNMJO_STRONG_CORR_Ben_OBS_leadTm"+str(leadTm)+"_ensm"+str(seed_num)+"_rund"+str(index+1)+"_Prdct_Test.nc")
    # wrt to netCDF
    os.system("rm -rf " + dirSave + "CNNMJO_STRONG_CORR_Ben_OBS_leadTm"+str(leadTm)+"_ensm"+str(seed_num)+"_rund"+str(index+1)+"_Prdct_Test.nc")
    create_NC = Dataset(dirSave+"CNNMJO_STRONG_CORR_Ben_OBS_leadTm"+str(leadTm)+"_ensm"+str(seed_num)+"_rund"+str(index+1)+"_Prdct_Test.nc", "w", format="NETCDF4")
