...
# ### ViT for MJO Compute STRONG Bivariate Correlation - V1
# ### Ben Crair
# ### March 21st
...
for i in range(num_ensembles):
    ...
    for j in range(num_rounds):
        in1 = Dataset(directory + "ViTMJO_STRONG_CORR_Ben_OBS_leadTm"+str(leadTm)+"_ensm"+str(i+1)+"_rund"+str(j+1)+"_Prdct_Train.nc")
        in2 = Dataset(directory + "ViTMJO_STRONG_CORR_Ben_OBS_leadTm"+str(leadTm)+"_ensm"+str(i+1)+"_rund"+str(j+1)+"_Prdct_Val.nc")
        in3 = Dataset(directory + "ViTMJO_STRONG_CORR_Ben_OBS_leadTm"+str(leadTm)+"_ensm"+str(i+1)+"_rund"+str(j+1)+"_Prdct_Test.nc")
